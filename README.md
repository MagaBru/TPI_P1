...
1. **Mostrar todos los países:** Lectura directa y formateo del archivo de datos.
2. **Agregar un país:** Validación de campos obligatorios no vacíos.
3. **Actualizar datos:** Modificación de población y superficie buscando por coincidencia exacta de nombre.
4. **Buscar país:** Búsqueda por coincidencia parcial o exacta.
5. **Filtrar países:** Por continente, rango de población o rango de superficie.
6. **Ordenar países:** Por nombre, población o superficie de forma ascendente o descendente.
7. **Estadísticas avanzadas:** País con mayor/menor población, promedios globales y conteo por continente.
